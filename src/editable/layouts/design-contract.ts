...
export const editableRootStyle = {
  ...
  '--slot4-muted-text': '#57524d',
  '--slot4-soft-muted-text': '#756f68',
  '--slot4-accent': '#ff3f2f',
  '--slot4-accent-fill': '#ff3f2f',
  '--slot4-accent-soft': '#ffe5dc',
  '--slot4-dark-bg': '#101010',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#ddd8d0',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#fbf8f3',
  '--slot4-lavender': '#f0ede8',
  '--slot4-gray': '#f7f5f1',
  '--slot4-body-gradient': 'radial-gradient(circle at 12% 8%, rgba(255,63,47,0.11), transparent 26rem), linear-gradient(180deg, #fbf8f3 0%, #f4f1ec 48%, #ffffff 100%)',
  '--editable-border': 'rgba(17, 17, 17, 0.10)',
  '--editable-container': '1120px',
  '--editable-page-bg': '#f4f1ec',
